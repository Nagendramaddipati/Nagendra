...
- banner:
  - dialog "Alert":
    - text: Alert
    - img
    - text: "• Starting Oct 1,2025, only Aadhaar authenticated users are allowed to book tickets during first 15 minutes of the first day of opening of reserved ticket booking. • Starting July 1, 2025, only Aadhaar authenticated users are allowed to book Tatkal Train Tickets on the IRCTC Website and Mobile Apps. Avoid last-minute inconvenience! Authenticate your IRCTC User ID now by following these steps: o Log in to IRCTC website or IRCTC Rail Connect Mobile App. o Go to \"My Account\". o Click on “Authenticate User” and complete the process. Stay prepared for a hassle-free Tatkal booking experience! • 1 अक्टूबर 2025 से आरक्षित टिकट बुकिंग खुलने के प्रथम दिन के पहले 15 मिनट के दौरान केवल आधार प्रमाणित उपयोगकर्ताओं को ही टिकट बुक करने की अनुमति है। • 1 जुलाई 2025 से केवल आधार प्रमाणित उपयोगकर्ताओं को ही आईआरसीटीसी वेबसाइट और मोबाइल ऐप पर तत्काल ट्रेन टिकट बुक करने की अनुमति है। नीचे दिए गए निर्देशों का पालन करते हुए, अपने उपयोगकर्ता (यूजर आई डी)को समय से आधार द्वारा प्रमाणित करें और असुविधा से बचें: o आईआरसीटीसी वेबसाइट या आईआरसीटीसी रेल कनेक्ट मोबाइल ऐप में लॉगिन करें ! o \" मेरा खाता\" में जाएं ! o \" उपयोगकर्ता को प्रमाणित करें\" पर क्लिक करें और प्रक्रिया को पूरी करें !"
    - button: OK
  - banner:
